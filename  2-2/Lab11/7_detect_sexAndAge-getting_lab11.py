...
style = '/Users/mac/Downloads/Use image Processing/style.xml'
video_capture = cv2.VideoCapture(0)
faceCascade = cv2.CascadeClassifier(style)
...
deploy_age = '/Users/mac/Downloads/Use image Processing/deploy_age.prototxt'  # แก้: ลบ quote เกินออก
deploy_gender = '/Users/mac/Downloads/Use image Processing/deploy_gender.prototxt'
age_net_path = '/Users/mac/Downloads/Use image Processing/age_net.caffemodel'    # แก้: เปลี่ยนชื่อไม่ชนกับตัวแปรใน function
gender_net_path = '/Users/mac/Downloads/Use image Processing/gender_net.caffemodel'

def load_caffe_models():
    age_net = cv2.dnn.readNetFromCaffe(deploy_age, age_net_path)      # แก้: ใช้ path variable ใหม่
    gender_net = cv2.dnn.readNetFromCaffe(deploy_gender, gender_net_path)
...
def video_detector(age_net,gender_net):
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            face_img = frame[y:y + h, x:x + w].copy()  # แก้: x แทน h ในมิติที่ 2
            print(face_img)
